...
public class PatientDetails2 extends AppCompatActivity {

    FirebaseFirestore firestore;
    TextView name , email , phone , age , gender , symptoms , pincode , shift , checked;
    String PatientName;
    String DocName;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = findViewById(R.id.scrview2);
        ...
        ref.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if (documentSnapshot.exists()) {
                    ...
                    else if (documentSnapshot.getString("isChecked").equals("0")) {
                        checked.setText("Active");
                    }
                }
            }
            ...
            public void onFailure(@NonNull @NotNull Exception e) {
                Toast.makeText(PatientDetails2.this, "Not Done", Toast.LENGTH_SHORT).show();
            }
        });
